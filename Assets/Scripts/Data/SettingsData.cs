...
public class SettingsData {
    ...
    public static SettingsData LoadOldData(SettingsData old){
        SettingsData template = new SettingsData();
    ...
    public static bool GetBool(string index){
        try{
            ...
            Debug.LogError("Attempted to access saved bool called \"" + index + "\", but no such saved var exists. Returning false.");
            return false;
        }
    }
    ...
    public static bool HasValue(string key){
        ...
        return current.savedVars.ContainsKey(key);
    }
